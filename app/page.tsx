...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md shadow-mist-subtle">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-5 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            <span className="font-serif text-base sm:text-lg lowercase text-text-primary">parker</span>
          </Link>

          <div className="flex items-center gap-3 sm:gap-6">
            <Link href="/mission" className="text-xs sm:text-sm text-text-secondary hover:text-text-primary transition">
              Misión
            </Link>
            <a
              ...
              className="px-4 sm:px-6 py-2 sm:py-3 rounded-2xl bg-primary text-white text-xs sm:text-sm font-medium hover:bg-primary-dark transition shadow-sm"
            >
      ...
      <section className="pt-24 sm:pt-28 md:pt-32 pb-12 sm:pb-16 md:pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-20 items-center">
          <div className="space-y-6 sm:space-y-8 md:space-y-10 order-2 lg:order-1">
            <div>
              <p className="text-xs sm:text-sm text-text-secondary font-medium mb-3 sm:mb-4 uppercase tracking-wide">
            ...
            <div className="flex flex-col gap-4 pt-2">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 px-5 sm:px-6 py-2.5 sm:py-3 rounded-2xl bg-primary text-white text-sm sm:text-base font-semibold hover:bg-primary-dark transition w-fit shadow-md hover:shadow-lg"
              >
          ...
          <div className="relative h-[400px] sm:h-[500px] md:h-[550px] lg:h-[600px] order-1 lg:order-2">
            <div className="relative h-full flex items-center justify-center">
              <div className="w-64 sm:w-72 h-full rounded-3xl bg-white shadow-sm border border-gray-100 flex items-center justify-center overflow-hidden">
                <div className="w-full h-full bg-white p-3 sm:p-4 flex flex-col">
                  ...
                  <div className="flex-1 flex flex-col gap-3 sm:gap-4 pt-3 sm:pt-4">
                    <div className="space-y-2 sm:space-y-3">
                      <div>
                        ...
                        <div className="text-xs text-gray-600 mb-2 sm:mb-3">Este mes</div>
                      </div>
                      <div>
                        <div className="flex justify-between items-baseline mb-1">
                        ...
                        <div className="text-xs text-gray-600 mb-2 sm:mb-3">Esta semana</div>
                      </div>
                      <div>
                        <div className="flex justify-between items-baseline mb-1">
      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 bg-background relative z-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {[
              ...
              <div key={i} className="bg-white rounded-3xl shadow-sm border border-border-ultra-subtle p-6 sm:p-8 md:p-10">
                {/* Estrellas grises */}
                ...
                {/* Quote en serif */}
                <blockquote className="font-serif text-lg sm:text-xl font-semibold text-text-primary mb-3 sm:mb-4 leading-snug">
                  "{item.quote}"
                </blockquote>
      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8 sm:mb-12 md:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 sm:mb-4 text-text-primary">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
            {[
              ...
              <div
                key={i}
                className="group p-6 sm:p-8 rounded-3xl border border-border-subtle hover:border-border-medium hover:shadow-md transition-all cursor-pointer bg-white shadow-sm"
              >
